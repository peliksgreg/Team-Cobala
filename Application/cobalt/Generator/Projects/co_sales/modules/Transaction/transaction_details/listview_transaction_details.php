...
//****************************************************************************************
require 'path.php';
init_cobalt('View transaction details');

$page_title       = 'ListView: %%';
$db_subclass      = 'transaction_details';
$html_subclass    = 'transaction_details_html';
$arr_pkey_name    = array('entry_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add transaction details';
$edit_link        = 'Edit transaction details';
$delete_link      = 'Delete transaction details';
$view_link        = 'View transaction details';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_transaction_details.php';
$edit_page        = 'edit_transaction_details.php';
$delete_page      = 'delete_transaction_details.php';
$view_page        = 'detailview_transaction_details.php';
$csv_page         = 'csv_transaction_details.php';
$report_page      = 'reporter_transaction_details.php';
