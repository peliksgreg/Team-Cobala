...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_log_dtl->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_log_dtl->add($arr_form_data);
            
            require_once 'subclasses/log_info.php';
            $dbh_log_dtl = new log_info;
