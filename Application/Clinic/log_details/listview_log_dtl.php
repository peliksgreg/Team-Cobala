...
$page_title       = 'ListView: %%';
$db_subclass      = 'log_dtl';
$html_subclass    = 'log_dtl_html';
$arr_pkey_name    = array('log_dtl_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add log dtl';
$edit_link        = 'Edit log dtl';
$delete_link      = 'Delete log dtl';
$view_link        = 'View log dtl';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_log_dtl.php';
$edit_page        = 'edit_log_dtl.php';
$delete_page      = 'delete_log_dtl.php';
$view_page        = 'detailview_log_dtl.php';
$csv_page         = 'csv_log_dtl.php';
$report_page      = 'reporter_log_dtl.php';
