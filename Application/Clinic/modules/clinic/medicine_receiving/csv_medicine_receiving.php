...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel'])
    {
        ...
        redirect("listview_medicine_receiving.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_medicine_receiving_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_medicine_receiving->export_to_csv();
