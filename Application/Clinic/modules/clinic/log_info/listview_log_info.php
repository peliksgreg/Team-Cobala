...
$page_title       = 'ListView: %%';
$db_subclass      = 'log_info';
$html_subclass    = 'log_info_html';
$arr_pkey_name    = array('log_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add log info';
$edit_link        = 'Edit log info';
$delete_link      = 'Delete log info';
$view_link        = 'View log info';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_log_info.php';
$edit_page        = 'edit_log_info.php';
$delete_page      = 'delete_log_info.php';
$view_page        = 'detailview_log_info.php';
$csv_page         = 'csv_log_info.php';
$report_page      = 'reporter_log_info.php';
