...
//****************************************************************************************
require 'path.php';
init_cobalt('Edit hospital');

if(isset($_GET['hospital_id']))
{
    $hospital_id = urldecode($_GET['hospital_id']);
    require 'form_data_hospital.php';
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_hospital->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            ...
            $dbh_hospital->edit($arr_form_data);
