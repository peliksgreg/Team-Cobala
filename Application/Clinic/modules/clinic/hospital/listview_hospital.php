...
//****************************************************************************************
require 'path.php';
init_cobalt('View hospital');

$page_title       = 'ListView: %%';
$db_subclass      = 'hospital';
$html_subclass    = 'hospital_html';
$arr_pkey_name    = array('hospital_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add hospital';
$edit_link        = 'Edit hospital';
$delete_link      = 'Delete hospital';
$view_link        = 'View hospital';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_hospital.php';
$edit_page        = 'edit_hospital.php';
$delete_page      = 'delete_hospital.php';
$view_page        = 'detailview_hospital.php';
$csv_page         = 'csv_hospital.php';
$report_page      = 'reporter_hospital.php';
