...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        $message .= $dbh_medicine->sanitize($arr_form_data)->lst_error;
        extract($arr_form_data);

        if($dbh_medicine->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            ...
            $dbh_medicine->edit($arr_form_data);
