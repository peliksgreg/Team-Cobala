...
$page_title       = 'ListView: %%';
$db_subclass      = 'medicine';
$html_subclass    = 'medicine_html';
$arr_pkey_name    = array('medicine_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add medicine';
$edit_link        = 'Edit medicine';
$delete_link      = 'Delete medicine';
$view_link        = 'View medicine';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_medicine.php';
$edit_page        = 'edit_medicine.php';
$delete_page      = 'delete_medicine.php';
$view_page        = 'detailview_medicine.php';
$csv_page         = 'csv_medicine.php';
