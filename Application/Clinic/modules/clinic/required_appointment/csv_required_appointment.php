...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel'])
    {
        ...
        redirect("listview_required_appointment.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_required_appointment_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_required_appointment->export_to_csv();
