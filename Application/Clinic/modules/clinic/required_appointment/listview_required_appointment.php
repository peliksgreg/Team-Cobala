...
$page_title       = 'ListView: %%';
$db_subclass      = 'required_appointment';
$html_subclass    = 'required_appointment_html';
$arr_pkey_name    = array('required_appointment_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add required appointment';
$edit_link        = 'Edit required appointment';
$delete_link      = 'Delete required appointment';
$view_link        = 'View required appointment';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_required_appointment.php';
$edit_page        = 'edit_required_appointment.php';
$delete_page      = 'delete_required_appointment.php';
$view_page        = 'detailview_required_appointment.php';
$csv_page         = 'csv_required_appointment.php';
$report_page      = 'reporter_required_appointment.php';
