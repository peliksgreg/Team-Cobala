...
$page_title       = 'ListView: %%';
$db_subclass      = 'refstudentclearance';
$html_subclass    = 'refstudentclearance_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add refstudentclearance';
$edit_link        = 'Edit refstudentclearance';
$delete_link      = 'Delete refstudentclearance';
$view_link        = 'View refstudentclearance';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_refstudentclearance.php';
$edit_page        = 'edit_refstudentclearance.php';
$delete_page      = 'delete_refstudentclearance.php';
$view_page        = 'detailview_refstudentclearance.php';
$csv_page         = 'csv_refstudentclearance.php';
$report_page      = 'reporter_refstudentclearance.php';
