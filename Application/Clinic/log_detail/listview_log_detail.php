...
//****************************************************************************************
require 'path.php';
init_cobalt('View log detail');

$page_title       = 'ListView: %%';
$db_subclass      = 'log_detail';
$html_subclass    = 'log_detail_html';
$arr_pkey_name    = array('log_detail_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add log detail';
$edit_link        = 'Edit log detail';
$delete_link      = 'Delete log detail';
$view_link        = 'View log detail';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_log_detail.php';
$edit_page        = 'edit_log_detail.php';
$delete_page      = 'delete_log_detail.php';
$view_page        = 'detailview_log_detail.php';
$csv_page         = 'csv_log_detail.php';
$report_page      = 'reporter_log_detail.php';
